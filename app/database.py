...
class Session(Base):
    ...
    condition_order: Mapped[int] = Column(Integer, nullable=False)  # 1 or 2 (which task this is)
...
class Evaluation(Base):
    ...
    evaluator_model: Mapped[str] = Column(String, nullable=False)  # e.g. "gemini-2.5-flash"
